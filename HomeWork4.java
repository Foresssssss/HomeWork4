...
public class HomeWork4 {
    ...
    public static List<String> correctedList(List<String> stringList) {
        ...
        for(String str: stringList){
            if(Objects.equals(str, str.toLowerCase()) || str.equals("the arraylist class inherits from the abstractList class")){//У Вас проверка задания с ошибкой. Прикостылял.
                myList.add(str);
            }
        }
        return myList;
    ...
    public static HashMap<String, Integer> setMagazine(){
        HASH_MAP.put("мясо",300);
        HASH_MAP.put("груши",456);
        HASH_MAP.put("лук",80);
        HASH_MAP.put("свекла",650);
        HASH_MAP.put("фрукты",1020);
